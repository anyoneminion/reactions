...
self.used = true",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "2de3734c-b7cf-18c8-9e02-f18370f70023",
	},
	[2] = {
		["actions"] = {
		},
...
return mytarget ~= nil and cinfo ~= nil and (mytarget.id ~= cinfo.channeltargetid) and (cinfo.casttime - cinfo.channeltime >= 0.500)",
		...
		["timerStartOffset"] = -8,
		["used"] = false,
		["uuid"] = "37b6e95d-d3bd-0513-af05-3ca8c8e9f6c7",
	},
	[12] = {
		["actions"] = {
			[1] = {
...
return StopCastingTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "a5c6017a-c84f-1549-85ea-cd4c0feb98a8",
	},
	[13] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "ca3b8853-7ebe-5dd4-915f-3c82134b915c",
	},
	[14] = {
		["actions"] = {
			[1] = {
...
for _, chain in pairs(chainbuffs) do\
    ...
    if closest ~= nil then\
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "8505f835-7fa3-5853-bc71-2875269164d7",
	},
}
return obj1
