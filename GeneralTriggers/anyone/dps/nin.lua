local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "60294600-cfb8-27d6-8031-64f5a6a7f4ac",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 10000 - data.randomDelay + AnyoneCore.Settings.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
