local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "5ea4c9db-824c-0d74-ab3c-9df42e472d2a",
	},
	
	{
		actions = 
		{
			...
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "ACR_RikuNIN_Hotbar_ArmsLength = false\nACR_RikuNIN_Hotbar_SecondWind = false\nACR_RikuNIN_Hotbar_Feint = false\nACR_RikuNIN_Hotbar_Potion = false\nACR_RikuNIN_Hotbar_Sprint = false\nACR_RikuNIN_Hotbar_LegSweep = false\nACR_RikuNIN_Hotbar_Bloodbath = false\nACR_RikuNIN_Hotbar_LimitBreak = false\nACR_RikuNIN_Hotbar_LockFace = false\nACR_RikuNIN_Hotbar_Huton = false\nACR_RikuNIN_Hotbar_Doton = false\nACR_RikuNIN_Hotbar_Raiton = false\nACR_RikuNIN_Hotbar_Suiton = false\nACR_RikuNIN_Hotbar_ShukuchiHitbox = false\nACR_RikuNIN_Hotbar_ShukuchiMouse = false\nACR_RikuNIN_Hotbar_ShadeShift = false\nACR_RikuNIN_Hotbar_ArmorCrush = false\nACR_RikuNIN_CD = true\nACR_RikuNIN_Suiton = true\nACR_RikuNIN_TrickAttack = true\nACR_RikuNIN_HoldNinki = false\nACR_RikuNIN_BurnMudra = false\nACR_RikuNIN_PreTA = true\nACR_RikuNIN_DoTs = true\nACR_RikuNIN_Mug = true\nACR_RikuNIN_FastTA = false\nACR_RikuNIN_Ninjutsu = true\n\nif AnyoneCore.Data.PotsEnabled == true or AnyoneCore.Settings.PotionOverride == true then\n\t\tAnyoneCore.Data.PotsEnabled = nil\n\t\tACR_RikuNIN_Potion = true\nend\n\nif Player.localmapid == 777 and AnyoneCore.Settings.IfritPhasePot == true then\n\t\tACR_RikuNIN_Potion = false\nend\n\nself.used = true\n\n",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
		...
		timerStartOffset = 0,
		used = false,
		uuid = "fb6c5bb7-0b58-0bf8-9c42-a7ae69cfe0ff",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "eaf14189-b771-e5cb-88b1-a2f57b6cdb12",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "69f7b3eb-a257-9638-a08d-5d346e96d7d4",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 0 + AnyoneCore.Settings.PrepullHelper.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.enabled == true and Player.job == 30",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 12000 + AnyoneCore.Settings.PrepullHelper.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 6000 + AnyoneCore.Settings.PrepullHelper.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return gACRSelectedProfiles[Player.job] == \"SallyNIN\" and (SallyNIN.openerInfo.index == 1 or SallyNIN.openerInfo.index == 3 or SallyNIN.openerInfo.index == 5 or SallyNIN.openerInfo.index == 6)",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return gACRSelectedProfiles[Player.job] == \"SallyNIN\" and (SallyNIN.openerInfo.index == 2 or SallyNIN.openerInfo.index == 4)",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 9000 + AnyoneCore.Settings.PrepullHelper.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore ~= nil and AnyoneCore.Settings.PrepullHelper.sprint == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 6000",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.doton == true",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.doton == false",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.raiton == false",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.raiton == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "54ddf098-2b9e-c428-9e17-422b01ddcea8",
	},
	
	{
		actions = 
		{
			...
			
			{
				...
				luaNeedsWeaveWindow = false,
				luaReturnsAction = false,
				name = "sallynin - prepull no doton",
				potType = 1,
				setTarget = false,
				showPositionPreview = false,
				stopCasting = false,
		...
		timerStartOffset = 0,
		used = false,
		uuid = "fecff98b-9f79-d8bc-9b93-67bc80e0deeb",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b8dd37a8-ae15-d86d-8b3c-5b313d832855",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "35ce3db7-d9bc-430c-910d-86cdf7d24476",
	},
	
	{
		...
		timerStartOffset = -15,
		used = false,
		uuid = "322b5b9b-2c53-d8f5-911e-34ff4508dc51",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "aae82142-3fbb-8881-9054-a010b340fa79",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "c1347bfb-4c7b-0ee2-b651-1f2f10b115f3",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "88bd2c44-21b1-ef49-a820-10f48de71fc7",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "839d5c33-4029-eb91-8370-ca876cdcd76a",
	},
	
	{
		actions = 
		{
			...
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "SallyNIN.SkillSettings.Jumps.enabled = false\nself.used = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
		...
		timerStartOffset = 0,
		used = false,
		uuid = "7d666fe2-dfb1-9b95-a17f-9e1444796bba",
	},
	
	{
		actions = 
		{
			...
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "SallyNIN.SkillSettings.Jumps.enabled = true\ndata.InNeurolink = false\nself.used = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
		...
		timerStartOffset = 0,
		used = false,
		uuid = "669b62c5-56f4-4ca5-a75f-ac215128811c",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "dfc149b0-47ce-9178-a2a7-2973181130ed",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "5289e9ce-26ef-a6a0-93a1-245828115ff4",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "cd799e41-9208-b6c2-ba4a-56d9984ebf44",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "2c06e17c-b891-68a9-b86f-e8a54db3b52d",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "006e86ec-eb73-038d-b31c-9d4ea789b422",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b2908b15-ce3f-7d1e-9522-9b368f61b49d",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "e867a7c5-8092-a3a6-8e2c-e6791ef94efd",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "4dbf80d1-2162-83d7-9def-4b6e6eab553f",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "24a19cc7-4017-3807-a3c0-ec89e2f38e09",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "9333ec2c-d295-07f6-9073-bf82e46adbb8",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "79ab2ec7-ff5f-356a-bdd2-001896b1afc6",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "97b06a83-2e57-df1c-ba2d-ffa702316edb",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f53a3baf-a087-e334-81bd-4c90caaa48cf",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ecba3424-91ed-c93e-836d-27b88554451e",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "dcc3dc7c-c95a-6307-8643-a61995365aed",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "5b921b56-9f1b-f819-bb49-8259ac72812b",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "84c0e355-df82-04a3-9d24-232ae0eb3d4e",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "fb2ef72a-624f-607b-99f4-291a22ddf05d",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b988a6fc-fa2c-319f-8f25-f35e16ef1664",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "6a092ddf-6e0e-f5bc-ba60-2b881f75f1a5",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f7e9316b-d530-5d82-9718-b98ca8bdbd73",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "53d41483-8eb7-e95c-a691-334e8dc80db4",
	},
}
