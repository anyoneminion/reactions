local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "25123d9b-f40a-f5f3-8be1-e386d5f03a69",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "7ca6ab72-c8ea-dd1c-bdee-ba2ce3a822f1",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "data.nail = EntityList:Get(eventArgs.detectionTargetID)\ndata.currentnailtarget = Player:GetTarget()\nif (data.nail == nil or current == nil) then return false end\nif data.currentnailtarget.HP.percent < 50 and data.nail.id ~= data.currentnailtarget.id and data.nail.contentid == 1186 then\n    return true\nelse\n    return false\nend\nreturn false",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "55b8b13d-1aec-47ca-9a31-39bff1065b1e",
	},
	...
	
	{
		...
		timerStartOffset = -8,
		used = false,
		uuid = "722ba06b-060f-33ba-9a61-dbf658f98713",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "93180f9c-fc80-323c-af21-3d256a03dad6",
	},
