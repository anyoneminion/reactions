...
return time ~= nil";
			...
			[11] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return data.countdownTime ~= nil and (xivopeners ~= nil and (xivopeners.running == false)) and ACR_TensorRequiem_Potion == true and gACRSelectedProfiles[Player.job] == \"TensorRequiem\" and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 2200\
";
				["conditionType"] = 1;
				["conditions"] = {
				};
...
self.used = true";
	...
	[8] = {
		...
		if Player.job ~= 23 and AnyoneCore.Settings.JobCheck == true then\
				...
				SendTextCommand(\"/e You're using the wrong general triggers. Check that you're set to the bard profile. <se.1>\")\
...
self.used = true\
self.eventConditionMismatch = true -- suppress log";
		["executeType"] = 2;
		["lastUse"] = 0;
		["luaNeedsWeaveWindow"] = false;
		["luaReturnsAction"] = false;
