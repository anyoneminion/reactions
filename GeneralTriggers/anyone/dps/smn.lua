...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "b3fe66f7-2331-22ba-8860-95475a5716b1";
	};
	[2] = {
		["actions"] = {
		};
...
";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "a24192f1-bde5-fdae-9e26-2521740fc217";
	};
	[22] = {
		["actions"] = {
			[1] = {
...
\
if furthest and (furthestDist < 15) then\
    Argus.addCircleFilled(furthest.pos.x, furthest.pos.y, furthest.pos.z, 6, 30, GUI:ColorConvertFloat4ToU32(255, 0, 0.1, 0.2), GUI:ColorConvertFloat4ToU32(100, 100, 0, 1), 2)\
end\
\
if furthest and (furthestDist >= 15) then\
...
\
if secondFurthest and (secondFurthestDist >= 15) then\
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "256c6883-ba54-3184-af65-719df1a372e8";
	};
	[23] = {
		["actions"] = {
		};
...
return StopCastingTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "657ccb9a-2a7c-3be5-b90e-dd999a7c3be9";
	};
	[26] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "db70bb84-640d-bc55-a32d-03cde6eb9c96";
	};
	[27] = {
		["actions"] = {
			[1] = {
...
for _, chain in pairs(chainbuffs) do\
    ...
    if closest ~= nil then\
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "9fb158ee-6308-cba0-92c4-5ad5472cf848";
	};
}
return obj1
