...
if (AnyoneCore ~= nil) then \
	...
	if lastStatusCheck ~= nil and lastStatusCheck2 == true then\
		if TimeSince(lastStatusCheck) > 5000 then\
			...
			elseif output == nil then\
				lastStatusCheck = Now()\
				d(\"[AnyoneCore] Updater: Download status file still nil, trying to check again. This is normal, but if not completed after five cycles, something is wrong...\")\
			end\
		end\
	end\
	...
	if lastStatusCheck3 ~= nil and lastStatusCheck4 == true then\
		if TimeSince(lastStatusCheck3) > 2000 then\
			...
			elseif output == nil then\
				lastStatusCheck3 = Now()\
				d(\"[AnyoneCore] Update checker: Version file still nil, trying to check again. This is normal, but if not completed after three cycles, something is wrong...\")\
			end	\
		end\
	end\
end\
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "8d2227ff-2297-ea33-8115-56c0691636b3";
	};
	[2] = {
		["actions"] = {
		};
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "fd7b009c-917d-2ecd-83bd-c11b6705bd5a";
	};
	[23] = {
		["actions"] = {
		};
...
return KnockbackTable[eventArgs.spellID] == true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "e6f8299d-a006-cd84-8f06-217b29231ecc";
	};
	[29] = {
		["actions"] = {
		};
