...
multiRefObjects[5][1] = 19367;
multiRefObjects[5][2] = 19465;
local obj1 = {
	[1] = {
		["actions"] = {
		};
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "54ada816-c36b-ab73-9ffb-f6b389ca8fa8";
	};
	[2] = {
		["actions"] = {
		};
...
Argus.addConeFilled(Player.pos.x, Player.pos.y, Player.pos.z, radius, math.rad(30), Player.pos.h-math.rad(60), 30, GUI:ColorConvertFloat4ToU32(0, 1, 0, 0.1), GUI:ColorConvertFloat4ToU32(0, 1, 0, 1), 2)\
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "358f1746-b97d-854f-b4f7-c24410277832";
	};
	[10] = {
		["actions"] = {
			[1] = {
...
return spellCheck[eventArgs.spellID] == true and caster and caster.castinginfo.casttime <= 0.01";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "8d443382-5b96-b33a-bd48-d8f5f3a429e9";
	};
	[11] = {
		["actions"] = {
		};
...
return KnockbackTable[eventArgs.spellID] == true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "7e2854a7-d424-7424-bae9-4271bf26cf4e";
	};
}
return obj1
