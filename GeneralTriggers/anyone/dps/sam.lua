local tbl = 
{
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper.enabled == true and Player.job == 34",
				conditionType = 1,
				conditions = 
				{
				},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "42920f2d-b1ce-0037-9e04-2461e3759a65",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "02a4f2eb-f26a-5e08-bbef-f937cbe4ea71",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "049ad591-4346-15ed-bd03-5b767aa4f170",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ce2c9e9d-0dcc-fa7e-92a0-4f9d57a3f5ef",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "ac0fe8f5-5bd2-4b08-b5b0-c92c31c11fed",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "b185fcc1-d499-d68b-9a7c-19ab09fff957",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "c71de5a1-2026-5d0e-aa43-b42f7815ee19",
	},
	
	{
		actions = 
		{
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "local mt = EntityList:Get(eventArgs.detectionTargetID)\nlocal nearby = TensorCore.entityList(\"attackable, targetable, alive, type=2\")\nfor id,ent in pairs(nearby) do\n    local blEntry = TensorCore.API.TensorWeeb.getBlacklistEntry(ent.contentid)\n    if (mt.hp.max*8) >= ent.hp.current and blEntry == nil then\n        AnyoneCore.log(\"[\" .. ent.contentid .. \"] \" .. ent.name .. \" HP (\" .. ent.hp.current .. \") lower than tanks HP*8 (\" .. mt.hp.max*8 .. \") adding to DoT blacklist.\", 2)\n        TensorCore.API.TensorWeeb.addBlacklistEntry(ent.contentid)\n    elseif (mt.hp.max*8) <= ent.hp.current and blEntry ~= nil and blEntry.enabled then\n        AnyoneCore.log(\"[\" .. ent.contentid .. \"] \" .. ent.name .. \" HP (\" .. ent.hp.current .. \") higher than tanks HP*8 (\" .. mt.hp.max*8 .. \") removing from DoT blacklist.\", 2)\n        TensorCore.API.TensorWeeb.deleteBlacklistEntry(ent.contentid)\n    end\nend\nself.used = true\nreaction.eventConditionMismatch = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
		...
		timerStartOffset = 0,
		used = false,
		uuid = "612ccb03-685f-464a-8ebb-f46c0f902014",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "fc0b383b-eebd-6ad0-8b9a-f1c1b7c88ad2",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "cdc8482f-b39e-86c1-a222-cd29976b57e3",
	},
}
