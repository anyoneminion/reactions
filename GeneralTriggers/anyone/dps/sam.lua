	...
	[3] = {
		["actions"] = {
			[1] = {
				["aType"] = 4;
				["actionID"] = -1;
				["actionLua"] = "if Player.localmapid == 906 and Player.job == 34 then\
 xivopeners.settings[Player.job].currentOpenerIndex = 1\
	xivopeners.supportedJobs[Player.job].queueOpener()\
 self.used = true\
 self.eventConditionMismatch = true\
end\
\
if Player.localmapid == 907 and Player.job == 34 then\
 xivopeners.settings[Player.job].currentOpenerIndex = 1\
 xivopeners.supportedJobs[Player.job].queueOpener()\
 self.used = true\
 self.eventConditionMismatch = true\
...
\
if Player.localmapid == 908 and Player.job == 34 then\
 xivopeners.settings[Player.job].currentOpenerIndex = 3\
 xivopeners.supportedJobs[Player.job].queueOpener()\
 self.used = true\
 self.eventConditionMismatch = true\
end\
\
if Player.localmapid == 909 and Player.job == 34 then\
 xivopeners.settings[Player.job].currentOpenerIndex = 1\
 xivopeners.supportedJobs[Player.job].queueOpener()\
 self.used = true\
 self.eventConditionMismatch = true\
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "d780f5cb-6189-6a63-b9c8-16f55abb7d95";
	};
	[16] = {
		["actions"] = {
			[1] = {
...
return false";
			...
			[2] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 34 and AnyoneCore.Settings.DutyHelperTargeting == true and AnyoneCore.Settings.DutyHelper == true";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = -8;
		["used"] = false;
		["uuid"] = "31047681-6931-216a-a9cb-2cead1427e17";
	};
	[19] = {
		["actions"] = {
			[1] = {
...
return false";
			...
			[2] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 34 and AnyoneCore.Settings.DutyHelperMitigation == true and AnyoneCore.Settings.DutyHelper == true";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["luaNeedsWeaveWindow"] = false;
		["luaReturnsAction"] = false;
		["name"] = "mitigate - duty helper - disabled";
		["throttleTime"] = 0;
		["time"] = 0;
		["timeRange"] = false;
		["timelineIndex"] = 0;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "3086c1ed-a4d7-9d07-b22d-31d289ef4236";
	};
	[20] = {
		["actions"] = {
			[1] = {
...
return false";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "e0a03caf-a7b0-c381-a832-8992808f101d";
	};
}
return obj1
