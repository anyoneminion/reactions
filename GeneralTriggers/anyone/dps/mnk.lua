local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "c667bafb-ac21-be67-880d-2b5b0ef8d28c",
	},
	...
	
	{
		actions = 
		{
			...
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "SallyMNK.SkillSettings.PrePull.enabled = false\nself.used = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper == true and Player.job == 20",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 11000 + AnyoneCore.Settings.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "2195104e-152b-d056-b8f8-01fd769d9073",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "d148b2f1-d601-0860-bb55-f8f2c68a83ad",
	},
