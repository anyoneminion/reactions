local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "a6dce04b-bea3-d4a4-9a67-6de85ac99b39",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return SallyMNK.SkillSettings.ShoulderTackle.enabled == true",
				conditionType = 1,
				conditions = 
				{
				},
