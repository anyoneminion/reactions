...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "0e35aa40-c024-a8da-9502-c09546e6d075";
	};
	[2] = {
		["actions"] = {
		};
...
";
	...
	[6] = {
		...
		if Player.job ~= 37 then\
				...
				TensorCore.sendParsedChatMessage(\"/e {color:0, 255, 0} You're using the wrong general triggers. You're currently using the {color:255,0,0}Gunbreaker{color:0,255,0} profile, which doesn't match your current job. <se.1>\")\
...
return StopCastingTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "43c8180d-df0d-99f9-853a-71f1f45be094";
	};
	[11] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "56d89cb3-19e1-49db-b5de-2d216b29d08f";
	};
	[12] = {
		["actions"] = {
			[1] = {
