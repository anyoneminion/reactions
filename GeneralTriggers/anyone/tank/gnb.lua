	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return (FFXIV_Common_BotRunning or AnyoneCore.Settings.DutyHelper.requirebotenabled == false) and AnyoneCore.Settings.HealingUsageDH == true and AnyoneCore.Settings.DutyHelper.enabled == true",
				conditionType = 1,
				conditions = 
				{
				},
	...
	
	{
		actions = 
		{
			
			{
				aType = 4,
				actionID = -1,
				actionLua = "data.playerpos = Player.pos\nself.used = true",
				allowInterrupt = false,
				atomicPriority = false,
				castAtMouse = false,
				castPosX = 0,
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.playerpos ~= nil and AnyoneCore.Distance3D(Player.pos, data.playerpos) >= 2",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "6d55d15f-9d80-4edc-ac84-1b36eb400494",
	},
}
