...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "04ca5959-f01c-952b-aa5f-911f720588ef";
	};
	[2] = {
		["actions"] = {
		};
...
return mytarget ~= nil and cinfo ~= nil and (mytarget.id ~= cinfo.channeltargetid) and (cinfo.casttime - cinfo.channeltime >= 0.500)";
		...
		["timerStartOffset"] = -8;
		["used"] = false;
		["uuid"] = "35a28ba3-6f93-bd0a-92cb-6bf9f232a826";
	};
	[10] = {
		["actions"] = {
			[1] = {
	...
	[14] = {
		...
		["conditions"] = {
			...
			[3] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "count = 0\
\
for _, ent in pairs(EntityList(\"targetingme,maxdistance=5\")) do\
count = count+1\
end\
\
return count >= 4";
