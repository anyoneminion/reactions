...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "7205d87d-f52d-d5ae-b270-6ab3ff70babb";
	};
	[2] = {
		["actions"] = {
		};
...
";
	...
	[6] = {
		...
		if Player.job ~= 19 then\
				...
				TensorCore.sendParsedChatMessage(\"/e {color:0, 255, 0} You're using the wrong general triggers. You're currently using the {color:255,0,0}Paladin{color:0,255,0} profile, which doesn't match your current job. <se.1>\")\
...
return StopCastingTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "2489e398-4632-5f8a-af63-203a9acfd0ab";
	};
	[11] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "e6b9db32-9a60-3eff-b473-bd766a8388d0";
	};
	[12] = {
		["actions"] = {
			[1] = {
...
return KnockbackTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "50b66c3a-8ce0-1817-b89f-02f243f6509d";
	};
	[13] = {
		["actions"] = {
			[1] = {
...
return KnockbackTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "52367e6b-fba0-a1ed-8b6b-e913f1a5d253";
	};
	[14] = {
		["actions"] = {
			[1] = {
...
for _, chain in pairs(chainbuffs) do\
    ...
    if closest ~= nil then\
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "2df1bb7e-9893-eefc-b166-9ef7d74b6da0";
	};
	[20] = {
		["actions"] = {
			[1] = {
