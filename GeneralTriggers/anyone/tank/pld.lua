local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "c02fe7c3-41bb-6aa2-b32b-c2c26c84a873",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "9df49bfb-966b-cf8b-923a-4f68534ecaab",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return AnyoneCore.Settings.PrepullHelper == true and Player.job == 19",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 10000 + AnyoneCore.Settings.BadTeamDelay - data.randomDelay",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 5000 - data.randomDelay + AnyoneCore.Settings.BadTeamDelay",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "0b271f5e-a7a6-2925-90ec-c25a43073fac",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "610f40d6-4f3d-0425-b245-b224a9791f68",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "data.mytarget = Player:GetTarget()\ndata.playercinfo = Player.castinginfo \nreturn data.mytarget ~= nil and data.playercinfo ~= nil and data.playercinfo.channeltargetid ~= nil and (data.mytarget.id ~= data.playercinfo.channeltargetid) and (data.playercinfo.casttime - data.playercinfo.channeltime >= 0.500)",
				conditionType = 5,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "if Player:GetTarget() ~= nil then\ndata.inanimatetarget = Player:GetTarget()\nend\nreturn data.inanimatetarget ~= nil and data.inanimatetarget.contentid < 30000",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = -8,
		used = false,
		uuid = "9694bec6-3869-2ca4-8338-1334dedd9531",
	},
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "6e90f401-ffa9-9329-9ad5-132bfe5b0493",
	},
