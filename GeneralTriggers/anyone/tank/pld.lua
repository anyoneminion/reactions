local tbl = 
{
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "f8f89117-f05e-d3ff-b874-dfc6596657d8",
	},
	...
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return gACRSelectedProfiles[Player.job] == \"SallyPLD\" and (xivopeners ~= nil and (xivopeners.running == false))",
				conditionType = 1,
				conditions = 
				{
				},
