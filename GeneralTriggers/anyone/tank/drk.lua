local tbl = 
{
	...
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "354c21f9-0dfa-3de1-9361-80df141fd98f",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "57017ae9-55c4-bbbb-a43c-1902cf68d019",
	},
	
	{
		...
		timerStartOffset = 0,
		used = false,
		uuid = "e931bca0-50b7-0505-bc26-e785f9d17a07",
	},
	
	{
		...
		conditions = 
		{
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return (gACRSelectedProfiles[Player.job] == \"SallyDRK\" and SallyDRK.SkillSettings.Plunge.enabled == true) or (gACRSelectedProfiles[Player.job] == \"RikuDRK\" and ACR_RikuDRK_Jumps == true) or (gACRSelectedProfiles[Player.job] == \"Void\" and ACR_VoidSB_Plunge == true)",
				conditionType = 1,
				conditions = 
				{
				},
			...
			
			{
				...
				clusterRange = 30,
				comparator = 1,
				conditionLua = "return FFXIV_Common_BotRunning and AnyoneCore ~= nil and AnyoneCore.Settings.SafeDashing == true",
				conditionType = 1,
				conditions = 
				{
				},
		...
		timerStartOffset = 0,
		used = false,
		uuid = "a3c9b35b-3db7-32cf-a889-8234bd739104",
	},
