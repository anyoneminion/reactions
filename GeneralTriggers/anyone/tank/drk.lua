...
self.used = true",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "520058e9-1360-e9ff-9918-70d1a4b0029e",
	},
	[2] = {
		["actions"] = {
		},
...
return mytarget ~= nil and cinfo ~= nil and (mytarget.id ~= cinfo.channeltargetid) and (cinfo.casttime - cinfo.channeltime >= 0.500) or (data.stopCast ~= nil and (data.stopCast == true))",
		...
		["timerStartOffset"] = -8,
		["used"] = false,
		["uuid"] = "5473cb8f-6803-3c67-903f-a8e130226e5d",
	},
	[10] = {
		["actions"] = {
			[1] = {
...
return StopCasting[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "0848e561-4753-5089-81b2-d8419d9dab23",
	},
	[11] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "a8eeb3a9-fa51-10dc-bd96-7e34e3437e9a",
	},
	[12] = {
		["actions"] = {
			[1] = {
	...
	[17] = {
		...
		["conditions"] = {
			[1] = {
				...
				["category"] = 4,
				["comparator"] = 1,
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 32 and AnyoneCore.Settings.DutyHelperGrabAggro == true and AnyoneCore.Settings.DutyHelper == true",
				["conditionType"] = 1,
				["conditions"] = {
				},
				["contentid"] = -1,
...
return false",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "a3d77d10-711d-9663-8c41-3760df220c8a",
	},
	[18] = {
		["actions"] = {
		},
