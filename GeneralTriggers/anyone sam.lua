...
self.used = true";
		...
		["conditions"] = {
			[1] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "local selectedACR = gACRSelectedProfiles[Player.job]\
if selectedACR == \"TensorWeeb\" then\
return true\
end";
				["conditionType"] = 1;
				["conditions"] = {
...
";
			...
			[2] = {
				["aType"] = 4;
				["actionID"] = -1;
				["actionLua"] = "local selectedACR = gACRSelectedProfiles[Player.job]\
