...
return time ~= nil";
			...
			[4] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return data.countdownTime ~= nil and (xivopeners.settings[Player.job].useTincture == false or xivopeners.running == false) and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 800";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
			...
			[8] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return data.countdownTime ~= nil and (xivopeners.settings[Player.job].useTincture == true and xivopeners.running == true) and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 2200";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
