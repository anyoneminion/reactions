...
if time ~= nil then\
				...
				data.pelotonDelay = math.random(50, 3500)\
end\
self.used = true";
				["allowInterrupt"] = false;
				["castAtMouse"] = false;
...
return time ~= nil";
			...
			[4] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return data.countdownTime ~= nil and (xivopeners == nil or (xivopeners.settings[Player.job].useTincture == false or xivopeners.running == false)) and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 800";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
			...
			[8] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return data.countdownTime ~= nil and (xivopeners ~= nil and (xivopeners.settings[Player.job].useTincture == true and xivopeners.running == true)) and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 2200";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "c8adbf5f-5b06-0414-b39b-7b790198e8a6";
	};
	[8] = {
		["actions"] = {
			[1] = {
...
self.used = true";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "67050112-64b6-eb67-a9b5-a06e35d10eb9";
	};
	[9] = {
		["actions"] = {
		};
...
self.used = true";
	...
	[29] = {
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "19edc85c-0577-a098-b99a-29b4def30391";
	};
	[30] = {
		["actions"] = {
			[1] = {
...
return false";
			...
			[2] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 23 and AnyoneCore.Settings.DutyHelperTargeting == true and AnyoneCore.Settings.DutyHelper == true";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = -8;
		["used"] = false;
		["uuid"] = "bb5020f7-5b24-bb10-a12c-0d0d7086542a";
	};
	[31] = {
		["actions"] = {
			[1] = {
...
return false";
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "b1fbc695-45ac-7836-b8dd-cc3bcb078880";
	};
	[32] = {
		["actions"] = {
			[1] = {
...
return false";
			...
			[2] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 23 and AnyoneCore.Settings.DutyHelperInterrupt == true and AnyoneCore.Settings.DutyHelper == true";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "ea78ab55-7946-64f8-a2a8-9eadd238db9b";
	};
	[33] = {
		["actions"] = {
			[1] = {
...
return false";
			...
			[2] = {
				...
				["category"] = 4;
				["comparator"] = 1;
				["conditionLua"] = "return FFXIV_Common_BotRunning and Player.job == 23 and AnyoneCore.Settings.DutyHelperKnockback == true and AnyoneCore.Settings.DutyHelper == true";
				["conditionType"] = 1;
				["conditions"] = {
				};
				["contentid"] = -1;
		...
		["timerStartOffset"] = 0;
		["used"] = false;
		["uuid"] = "cbe221eb-462c-5c1b-bb56-e05c73d7acca";
	};
}
return obj1
