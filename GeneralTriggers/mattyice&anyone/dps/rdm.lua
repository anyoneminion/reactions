...
self.used = true",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "fede8eca-6348-d60d-9ef4-0b05bd01b105",
	},
	[2] = {
		["actions"] = {
		},
...
return time ~= nil",
			...
			[4] = {
				...
				["category"] = 4,
				["comparator"] = 1,
				["conditionLua"] = "return data.countdownTime ~= nil and data.countdownDuration ~= nil and data.countdownDuration * 1000 - TimeSince(data.countdownTime) <= 5000 + data.BadTeamDelay",
				["conditionType"] = 1,
				["conditions"] = {
				},
				["contentid"] = -1,
...
return mytarget ~= nil and cinfo ~= nil and (mytarget.id ~= cinfo.channeltargetid) and (cinfo.casttime - cinfo.channeltime >= 0.500)",
		...
		["timerStartOffset"] = -8,
		["used"] = false,
		["uuid"] = "a2036ab4-a8d1-3bd3-9d63-65051a96328b",
	},
	[13] = {
		["actions"] = {
			[1] = {
...
return StopCastingTable[eventArgs.spellID] == true and caster and caster.castinginfo.casttime - caster.castinginfo.channeltime < 5",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "dba573f0-a6c3-23be-ab94-e76f4817747b",
	},
	[14] = {
		["actions"] = {
			[1] = {
...
return ClearTargetTable[eventArgs.buffID] == true and eventArgs.buffDuration <= 2",
		...
		["timerStartOffset"] = 0,
		["used"] = false,
		["uuid"] = "9b32cf81-68c5-d8c4-bff1-3b33415ad0aa",
	},
	[15] = {
		["actions"] = {
			[1] = {
