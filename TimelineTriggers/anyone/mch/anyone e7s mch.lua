...
self.used = true",
			...
			["timerStartOffset"] = 0,
			["used"] = false,
			["uuid"] = "d465171a-e9d4-5c5a-afd4-b0bdb4417e65",
		},
		[6] = {
			["actions"] = {
				[1] = {
...
self.used = true",
	...
	[51] = {
		...
		[5] = {
			...
			["enabled"] = true,
			["execute"] = "if data.AddsPhasePot == true and data.PotsEnabled == true then\
		...
		[5] = {
			["actions"] = {
				[1] = {
					["aType"] = 4,
					["actionID"] = -1,
					["actionLua"] = "if data.PotsEnabled == true and data.AddsPhasePot == true then\
...
self.used = true",
	...
	[106] = {
		[1] = {
			...
			["enabled"] = true,
			["execute"] = "if data.PotsEnabled == true and data.AddsPhasePot == true then\
ACR_TensorMagnum_CD = false\
self.used = true\
end\
self.used = true",
