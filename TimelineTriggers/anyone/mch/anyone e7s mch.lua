...
self.used = true";
	...
	[51] = {
		...
		[5] = {
			...
			["enabled"] = true;
			["execute"] = "if AnyoneReactionSettings.Settings.AddsPhasePot == true and data.PotsEnabled == true then\
		...
		[5] = {
			["actions"] = {
				[1] = {
					["aType"] = 4;
					["actionID"] = -1;
					["actionLua"] = "if data.PotsEnabled == true and AnyoneReactionSettings.Settings.AddsPhasePot == true then\
...
self.used = true";
	...
	[106] = {
		[1] = {
			...
			["enabled"] = true;
			["execute"] = "if data.PotsEnabled == true and AnyoneReactionSettings.Settings.AddsPhasePot == true then\
ACR_TensorMagnum_CD = false\
self.used = true\
end\
self.used = true";
		...
		[5] = {
			["actions"] = {
				[1] = {
					["aType"] = 4;
					["actionID"] = -1;
					["actionLua"] = "if data.AddsPhasePot == false then\
