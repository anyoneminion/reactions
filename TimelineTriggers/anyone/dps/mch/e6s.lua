...
\
ACR_TensorMagnum_SummonQueen_Gauge = AnyoneCore.Settings.e6sQueenGauge\
\
...
self.used = table.size(drawnOrbs) >= 7";
			...
			["timerStartOffset"] = -3;
			["used"] = false;
			["uuid"] = "5d2b260e-1aac-3a23-b950-17372f52869a";
		};
	};
	[16] = {
		[1] = {
...
self.used = table.size(drawnOrbs) >= 7";
			...
			["timerStartOffset"] = -3;
			["used"] = false;
			["uuid"] = "7c0c2756-1c72-6933-b7b2-9a38d68f489e";
		};
	};
	[49] = {
		[1] = {
