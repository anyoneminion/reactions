...
---an option named \"AnyoneCore\". Click that and change the settings as you please.";
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "a5aca75b-c1e5-1f69-9b01-3d47ecc00082";
		};
		[3] = {
			["actions"] = {
			};
...
";
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "b9586b2b-dcd5-660d-a8b8-f464fe3ba34b";
		};
	};
	[22] = {
		[1] = {
...
return true";
		...
		[3] = {
			...
			["timerStartOffset"] = -30;
			["used"] = false;
			["uuid"] = "e8cb3c76-0642-6446-8b8a-4ae28048ef36";
		};
		[4] = {
			["actions"] = {
				[1] = {
...
for id, ent in pairs(EntityList(\"\")) do\
	if ent.contentid == 9302 and not drawnOrbs[id] then\
...
\
for id, ent in pairs(EntityList(\"\")) do\
	if ent.contentid == 9303 and not drawnOrbs[id] then\
		if AnyoneCore.Settings.DrawOrbs == true then\
			drawnOrbs[id] = true\
			Argus.addTimedCircleFilled(20000, ent.pos.x, ent.pos.y, ent.pos.z, 5, 30, {r = 1, g = 0, b = 0}, 0.2, 0.2, 0, ent.id, GUI:ColorConvertFloat4ToU32(1, 0, 0, 1), 1.5)\
		end\
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["conditions"] = {
				[1] = {
					...
					["category"] = 4;
					["comparator"] = 1;
					["conditionLua"] = "return AnyoneCore.Settings.DrawBlackWhiteOrbs == true";
					["conditionType"] = 1;
					["conditions"] = {
					};
					["contentid"] = -1;
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "84a270df-366b-28e7-a1a7-5d7300f5e837";
		};
		[2] = {
			["actions"] = {
				[1] = {
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["luaNeedsWeaveWindow"] = false;
			["luaReturnsAction"] = false;
			["name"] = "draw white/black orbs +11s";
			["throttleTime"] = 0;
			["time"] = 683.7;
			["timeRange"] = false;
			["timelineIndex"] = 109;
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "af145b56-6db2-1c30-b8a7-f0368e3bf55f";
		};
		[3] = {
			["actions"] = {
				[1] = {
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["luaNeedsWeaveWindow"] = false;
			["luaReturnsAction"] = false;
			["name"] = "draw white/black orbs +22s";
			["throttleTime"] = 0;
			["time"] = 683.7;
			["timeRange"] = false;
			["timelineIndex"] = 109;
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "8b710522-b5a5-a20e-9af9-50035d255284";
		};
	};
	[113] = {
		[1] = {
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "5c6c4a46-247f-4a6c-8382-947414b93402";
		};
		[2] = {
			["actions"] = {
				[1] = {
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "483ec1e1-e0df-2086-b1ef-d120ac72ba10";
		};
		[3] = {
			["actions"] = {
				[1] = {
...
self.used = table.size(drawnOrbs) >= 2";
			...
			["timerStartOffset"] = 0;
			["used"] = false;
			["uuid"] = "e585db02-762c-38c2-b701-c5bc3152cf07";
		};
	};
	["mapID"] = 908;
	["version"] = 6;
