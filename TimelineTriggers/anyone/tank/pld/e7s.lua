...
--- IGNORE EVERYTHING PAST THIS POINT ---\
\
--- For the Unshadowed Stake mechanics, if the tether is on you and Hallowed Ground is available, it will get popped.\
--- If the tether is on you and HollowGround is not available, substitute cooldowns will be used instead.\
